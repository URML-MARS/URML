...
| **Real ROS 2 adapter** (`RclpyAdapter`) — full ROSAdapter Protocol via `rclpy` (Nav2 / MoveIt 2 / vision_msgs) | ✅ Implemented; end-to-end verified against a live TurtleBot 4 + Nav2 Gazebo simulation (gated CI, `gazebo-e2e` job green ×3) |
